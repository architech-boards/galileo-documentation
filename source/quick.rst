...
1. Return to the **Splashscreen**, which we left on Galileo board screen, and click on *Develop with Eclipse*.
...
Use an ethernet cable to connect the board (connector 10/100 LAN) to your PC.
...
then the ethernet connection is ok. Enable the remote debug with Yocto by typing this command on Galileo console:
