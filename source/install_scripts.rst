...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="install_scripts_rst-host-182" class="language-markup">git clone -b dora https://github.com/architech-boards/galileo-splashscreen.git
 cd galileo-splashscreen
