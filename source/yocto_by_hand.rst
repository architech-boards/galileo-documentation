...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="yocto_by_hand_rst-host-44" class="language-markup">repo init -u https://github.com/architech-boards/galileo-manifest.git -b dora -m manifest.xml</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
edit your **local.conf** and **bblayers.conf** to compile for galileo machine and using all the downloaded
meta-layers.
...
If you really want to download everything by hand, just clone branch *dora* of *meta-clanton_v1.0.1*:
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="yocto_by_hand_rst-host-47" class="language-markup">git clone -b dora https://github.com/architech-boards/meta-clanton_v1.0.1.git</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
